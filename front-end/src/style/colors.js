const colors = {
  ...
  button: {
    ...
    gradientBlueToPink:
      "bg-gradient-to-r from-blue-900 to-blue-900 hover:from-blue-800 hover:to-blue-800 active:from-blue-700 active:to-blue-700 text-white transition duration-200 ease-in-out",
