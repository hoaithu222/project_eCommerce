...
export default function SelectAttribute({
  ...
  return (
    <div className="relative flex items-center gap-4">
      <label className="text-sm font-medium bg-gradient-to-r from-pink-500 to-blue-500 bg-clip-text text-transparent">
        {attribute.name}
      </label>
      ...
      <div className="relative flex-1">
        <div
          className={`min-h-[42px] p-2 rounded-lg shadow-md bg-white cursor-pointer transition-all duration-200
            ${isOpen ? "ring-2 ring-opacity-50 ring-pink-400 border-transparent" : "hover:border-pink-300"}
            ${selectedValue ? "border-2 border-opacity-50 border-pink-300" : "border border-gray-200"}
            hover:shadow-lg`}
        ...
        >
          {!selectedValue ? (
            ...
            <span className="inline-flex items-center px-3 py-1 rounded-full bg-gradient-to-r from-pink-100 to-blue-100 text-sm font-medium">
              ...
              return (
                <div
                  ...
                  className={`flex items-center px-4 py-2.5 cursor-pointer transition-colors
                    ${isSelected ? "bg-gradient-to-r from-pink-50 to-blue-50" : "hover:bg-gradient-to-r hover:from-pink-50/30 hover:to-blue-50/30"}
