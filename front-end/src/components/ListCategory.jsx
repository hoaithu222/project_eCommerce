    ...
    <div className="container mx-auto py-4">
      <div className="p-6 bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-lg">
        ...
        <div
          ...
          className="flex items-center space-x-6 overflow-x-auto hidden-scrollbar py-4"
        ...
        >
          {category?.map((item, index) => (
            <Link
              to={`/${item.id}`}
              key={`${item.id}-${index}`}
              className="flex flex-col items-center min-w-[144px] group cursor-pointer"
            >
              <div className="relative">
                ...
                <div className="w-24 h-24 rounded-full bg-gradient-to-br from-white to-blue-50 p-3 mb-3 transition-all duration-300 group-hover:shadow-lg group-hover:-translate-y-2 relative">
              ...
              <div className="relative overflow-hidden">
                <h3 className="text-sm font-medium text-blue-500 text-center whitespace-nowrap transition-all duration-300 group-hover:text-blue-600">
                  {item.name}
                </h3>
