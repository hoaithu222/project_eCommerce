  ...
  return (
    <div className="bg-white rounded-lg shadow-sm">
      <div className="flex items-center p-5 border-b border-gray-200">
        <h2 className="text-2xl font-semibold bg-gradient-to-r from-green-500 to-purple-600 bg-clip-text text-transparent">
          Sản phẩm
        </h2>
      </div>
      ...
      <div className="divide-y divide-gray-100">
        {orders.map((shopOrder, shopIndex) => (
          <div key={`shop-${shopIndex}`} className="pb-4">
            {/* Shop header */}
            <div className="flex items-center gap-4 bg-sky-50 p-4">
              <div className="w-16 h-16 p-0.5 bg-pink-300 rounded-full overflow-hidden flex-shrink-0">
                <img
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row items-end md:items-center gap-4 ml-auto">
                    ...
                    <p className="text-orange-500 whitespace-nowrap">
                      {formatPriceVND(product.price_at_time * product.quantity)}
                    </p>
                  </div>
                </div>
              ))}
