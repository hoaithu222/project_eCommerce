export default function Loading() {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 bg-opacity-80 backdrop-blur-sm z-50">
      <div className="flex flex-col items-center gap-6">
        <div className="relative">
          <div className="w-32 h-32 rounded-full animate-spin-slow">
            <div className="w-full h-full rounded-full bg-gradient-to-tr from-blue-300 via-purple-300 to-blue-300 opacity-75"></div>
          </div>

          <div className="absolute top-4 left-4 w-24 h-24 rounded-full animate-spin-reverse">
            <div className="w-full h-full rounded-full bg-gradient-to-tr from-blue-300 via-orange-300 to-yellow-300 opacity-75"></div>
          </div>

          <div className="absolute top-8 left-8 w-16 h-16 bg-white rounded-full shadow-lg flex items-center justify-center">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-400 to-blue-400 animate-pulse"></div>
          </div>
        </div>
